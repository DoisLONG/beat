...
from ..proto.docarray import LLMParams, LLMParamsDoc, RerankedDoc, RerankerParms, RetrieverParms, TextDoc, McpParms
...
class ChatQnAGateway(Gateway):
    ...
    async def handle_request(self, request: Request):
        ...
        mcp_list = []
        is_mcp = False
        if hasattr(chat_request, "mcp_list") and chat_request.mcp_list:
            is_mcp = True
            mcp_list = chat_request.mcp_list
