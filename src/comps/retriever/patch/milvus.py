...
class Milvus(VectorStore):
    ...
    def __init__(
        ...
        *,
        ...
        print(f"langchain-milvus has index_params: {index_params} and assigned self.index_params: {self.index_params}")
    ...
    def _collection_search(
        ...
        **kwargs: Any,
        ...
        #print(f"_collection_search gets col_search_res: {col_search_res}")
    ...
    def _select_relevance_score_fn(self) -> Callable[[float], float]:
        ...
        """
        print(f"_select_relevance_score_fn has self.index_params: {self.index_params} at stage 0")
        print(f"_select_relevance_score_fn has self.col: {self.col} at stage 0")
        print(f"_select_relevance_score_fn has self.col.indexes: {self.col.indexes} at stage 0")
        ...
        def _map_ip_to_similarity(ip_score: float) -> float:
            ...
            print(f"_select_relevance_score_fn get ip_score: {ip_score}")
            return ip_score
