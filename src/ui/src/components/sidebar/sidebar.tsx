...
import { logout, setSelectedCollection } from "../../redux/Conversation/ConversationSlice"
...
export function SideNavbar({ navList }: SideNavbarProps) {
  ...
  const handleLogout = () => {
    dispatch(logout())
    dispatch(removeUser())
    dispatch(setSelectedCollection(undefined))
  }
  ...
  return (
    <nav className={classes.navbar}>
      ...
      { // Enable Logout Logo and logic if user is not 'Anonymous'
        name !== "Anonymous" ? (
